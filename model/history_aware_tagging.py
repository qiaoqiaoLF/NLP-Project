...
class SLUTagging(nn.Module):
    ...
    def __init__(self, config,Example_word_vocab):
        ...
        self.tokenizer = transformers.BertTokenizer.from_pretrained(self.pretrained_model)
        self.model = transformers.BertModel.from_pretrained(self.pretrained_model)
