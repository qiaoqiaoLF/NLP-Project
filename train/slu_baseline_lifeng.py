...
from model.slu_baseline_tagging_lifeng import SLUTagging
import transformers
...
def set_scheduler(optimizer,args,num_training_steps ):
    scheduler = transformers.get_cosine_schedule_with_warmup(
        optimizer, num_warmup_steps=int((args.warmup_epochs / args.max_epoch) * num_training_steps), num_training_steps=num_training_steps
    )
    return scheduler
...
if not args.testing:
    ...
    scheduler = set_scheduler(optimizer,args, int (num_training_steps))
