...
def add_argument_base(arg_parser):
    ...
    arg_parser.add_argument('--run_name', default='default', help='run name')
    ...
    arg_parser.add_argument('--warmup_epochs', default=10, type=int, help='warmup epochs')
    ...
    arg_parser.add_argument('--pretrained_model', default=None, type=str, help='pretrained model: \"hfl/chinese-macbert-base\", \"hfl/chinese-electra-180g-small-discriminator\"')
    return arg_parser